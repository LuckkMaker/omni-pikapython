...
#include "Math.h"
#include "TinyObj.h"
#include "Math_Adder.h"
#include "TinyObj.h"
#include "Math_Multiplier.h"
#include "TinyObj.h"
#include "PikaDebug.h"
#include "TinyObj.h"
...
void Math_MultiplierMethod(PikaObj *self, Args *args){
...
#ifndef PIKA_MODULE_MATH_DISABLE
void Math_Adder_byFloatMethod(PikaObj *self, Args *args){
    pika_float a = args_getFloat(args, "a");
    pika_float b = args_getFloat(args, "b");
    pika_float res = Math_Adder_byFloat(self, a, b);
...
void Math_Adder_byIntMethod(PikaObj *self, Args *args){
    int a = args_getInt(args, "a");
    int b = args_getInt(args, "b");
    int res = Math_Adder_byInt(self, a, b);
...
class_def(Math_Adder){
    __BEFORE_MOETHOD_DEF
    method_def(Math_Adder_byInt, 254804107),
    method_def(Math_Adder_byFloat, 452650166),
};
class_inhert(Math_Adder, TinyObj);

PikaObj *New_Math_Adder(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, Math_Adder);
    return self;
}

Arg *Math_Adder(PikaObj *self){
    return obj_newObjInPackage(New_Math_Adder);
}
#endif

#ifndef PIKA_MODULE_MATH_DISABLE
void Math_Multiplier_byFloatMethod(PikaObj *self, Args *args){
    pika_float a = args_getFloat(args, "a");
    pika_float b = args_getFloat(args, "b");
    pika_float res = Math_Multiplier_byFloat(self, a, b);
    method_returnFloat(args, res);
}
method_typedef(
    Math_Multiplier_byFloat,
    "byFloat", "a,b"
);

void Math_Multiplier_byIntMethod(PikaObj *self, Args *args){
    int a = args_getInt(args, "a");
    int b = args_getInt(args, "b");
    int res = Math_Multiplier_byInt(self, a, b);
    method_returnInt(args, res);
}
method_typedef(
    Math_Multiplier_byInt,
    "byInt", "a,b"
);

class_def(Math_Multiplier){
    __BEFORE_MOETHOD_DEF
    method_def(Math_Multiplier_byInt, 254804107),
    method_def(Math_Multiplier_byFloat, 452650166),
};
class_inhert(Math_Multiplier, TinyObj);

PikaObj *New_Math_Multiplier(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, Math_Multiplier);
    return self;
}

Arg *Math_Multiplier(PikaObj *self){
    return obj_newObjInPackage(New_Math_Multiplier);
}
#endif
